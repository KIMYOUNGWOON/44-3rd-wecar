...
import logoImage from '../../assets/mainImg/logoImg.png';
    ...
    <FooterBox>
      <FooterContent>
        ...
        <ListBox>
          ...
          <ListContent>일반 회원 안내</ListContent>
          <ListContent>공급 회원 안내</ListContent>
        </ListBox>
        <CustomerService>
          <CenterNumber>고객센터 1580-7813</CenterNumber>
          <HoursOfOperation>
